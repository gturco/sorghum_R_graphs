...
## 
## data:  freq by mtype
## Kruskal-Wallis chi-squared = 0.69467, df = 3, p-value = 0.8745
```
...
## 
## data:  freq by mtype
## Kruskal-Wallis chi-squared = 0.99486, df = 3, p-value = 0.8025
```
...
## 
## data:  freq by mtype
## Kruskal-Wallis chi-squared = 22.767, df = 3, p-value = 4.516e-05
```
