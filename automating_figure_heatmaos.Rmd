...
ggdraw() +
  ###x,y,w,h
  draw_plot(a, 0, 0.068, 0.323, 0.125) +
  draw_plot(a1, .033, 0, .098, 0.057) +
  draw_plot(a2, 0.132, 0, .098, 0.057)  +
  draw_plot(a3, 0.231, 0, .098, 0.057) +
  #C
  draw_plot(a, 0, 0.261, 0.323, 0.125) +
  draw_plot(a1, .033, 0.193, .098, 0.057) +
  draw_plot(a2, 0.132, 0.193, .098, 0.057)  +
  draw_plot(a3, 0.231, 0.193, .098, 0.057) +
  #B
  draw_plot(a, 0, 0.454, 0.323, 0.125) +
  draw_plot(a1, .033, 0.386, .098, 0.057) +
  draw_plot(a2, 0.132, 0.386, .098, 0.057)  +
  draw_plot(a3, 0.231, 0.386, .098, 0.057) +
  #A
    draw_plot(a, 0, 0.647, 0.323, 0.125) +
  draw_plot(a1, .033, 0.579, .098, 0.057) +
  draw_plot(a2, 0.132, 0.579, .098, 0.057)  +
  draw_plot(a3, 0.231, 0.579, .098, 0.057)
...
pdf("ultimateFIgure6.pdf", width=6.8136, height=10.85568, onefile=FALSE)
ggdraw() +
  ###x(w),y(h),w,h
  #### VERTICAL 1
  # D
  ...
  #C
  draw_plot(c, 0, 0.261, 0.323, 0.125) +
  draw_plot(c1, .033, 0.193, .098, 0.057) +
  draw_plot(c2, 0.132, 0.193, .098, 0.057)  +
  draw_plot(c3, 0.231, 0.193, .098, 0.057) +
  #B
  draw_plot(b, 0, 0.454, 0.323, 0.125) +
  draw_plot(b1, .033, 0.386, .098, 0.057) +
  draw_plot(b2, 0.132, 0.386, .098, 0.057)  +
  draw_plot(b3, 0.231, 0.386, .098, 0.057) +
  #A
    draw_plot(a, 0, 0.647, 0.323, 0.125) +
  draw_plot(a1, .033, 0.579, .098, 0.057) +
  draw_plot(a2, 0.132, 0.579, .098, 0.057)  +
 ...
 #### VERTICAL 2
  ...
  #G
  draw_plot(g, 0.329, 0.261, 0.323, 0.125) +
  draw_plot(g1, .362, 0.193, .098, 0.057) +
  draw_plot(g2, 0.46, 0.193, .098, 0.057)  +
  draw_plot(g3, 0.558, 0.193, .098, 0.057) +
  #F
  draw_plot(f, 0.329, 0.454, 0.323, 0.125) +
  draw_plot(f1, .362, 0.386, .098, 0.057) +
  draw_plot(f2, 0.46, 0.386, .098, 0.057)  +
  draw_plot(f3, 0.558, 0.386, .098, 0.057) +
  #E
  draw_plot(e, 0.329, 0.647, 0.323, 0.125) +
  draw_plot(e1, .362, 0.579, .098, 0.057) +
  draw_plot(e2, 0.46, 0.579, .098, 0.057)  +
  draw_plot(e3, 0.558, 0.579, .098, 0.057) +
 ...
 #### VERTICAL 3
  ...
  #K
  draw_plot(k, 0.656, 0.261, 0.323, 0.125) +
  draw_plot(k1, .689, 0.193, .098, 0.057) +
  draw_plot(k2, 0.787, 0.193, .098, 0.057)  +
  draw_plot(k3, 0.885, 0.193, .098, 0.057) +
  #J
  draw_plot(j, 0.656, 0.454, 0.323, 0.125) +
  draw_plot(j1, .689, 0.386, .098, 0.057) +
  draw_plot(j2, 0.787, 0.386, .098, 0.057)  +
  draw_plot(j3, 0.885, 0.386, .098, 0.057) +
  #I
  draw_plot(i, 0.656, 0.647, 0.323, 0.125) +
  draw_plot(i1, .689, 0.579, .098, 0.057) +
  draw_plot(i2, 0.787, 0.579, .098, 0.057)  +
  draw_plot(i3, 0.885, 0.579, .098, 0.057) 
