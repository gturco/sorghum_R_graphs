...
## 
## data:  freq by mtype
## Kruskal-Wallis chi-squared = 0.6947, df = 3, p-value = 0.8745
```
...
## 
## data:  freq by mtype
## Kruskal-Wallis chi-squared = 0.9949, df = 3, p-value = 0.8025
```
...
## 
## data:  freq by mtype
## Kruskal-Wallis chi-squared = 22.7671, df = 3, p-value = 4.516e-05
```
